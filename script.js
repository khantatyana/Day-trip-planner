$(document).ready(function() {
    ...
    // here should be $("#stateButton").val(); or stateCode from AJAX call
    // var stateCode = $("#stateButton").val();
...
for (var i = 0; i < stateArray.length; i++) {
    var li = $("<li class='pure-menu-item'>").appendTo(stateList);
    var stateInput = $("<input type='checkbox' id='stateInputBox' class='pure-checkbox' required=''>");    
        stateInput.text(stateArray[i]).attr("value",stateArray[i]).appendTo(li);
} 
